...
pub const PROVIDER_ID: &str = "mmx";
pub const PROVIDER_NAME: &str = "MiniMax";
pub const MODEL_PREFIX: &str = "mmx";
pub const BASE_URL: &str = "https://api.minimax.io/anthropic";
pub const VALIDATE_URL: &str = "https://api.minimax.io/anthropic/v1/messages";
pub const CATEGORY: &str = "apikey";
pub const COLOR: &str = "#7C3AED";
pub const ICON_NAME: &str = "minimax.png";
pub const DOCS_URL: &str = "https://www.minimaxi.com";
pub const API_KEY_URL: &str = "https://www.minimaxi.com";
