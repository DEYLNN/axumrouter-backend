pub const PROVIDER_ID: &str = "hcn";
pub const PROVIDER_NAME: &str = "Hcnsec";
pub const CATEGORY: &str = "apikey";
pub const COLOR: &str = "#6366F1";
pub const ICON_NAME: &str = "default_provider.png";
pub const BASE_URL: &str = "https://api.hcnsec.cn/v1";
...
pub fn provider_spec() -> crate::providers::spec::ProviderSpec {
    crate::providers::spec::ProviderSpec {
        ...
        category: CATEGORY,
        base_url: BASE_URL,
        validate_url: "https://api.hcnsec.cn/v1/models",
