...
pub const PROVIDER_ID: &str = "bmc";
pub const PROVIDER_NAME: &str = "BigModel China";
pub const MODEL_PREFIX: &str = "bmc";
pub const BASE_URL: &str = "https://open.bigmodel.cn/api/coding/paas/v4";
pub const VALIDATE_URL: &str = "https://open.bigmodel.cn/api/coding/paas/v4/models";
...
pub const MODELS: &[ModelDef] = &[
    ...
    ModelDef { id: "glm-4.6", name: "GLM 4.6", max_tokens: 202752, supports_vision: false, supports_tools: true },
    ModelDef { id: "glm-4.5-air", name: "GLM 4.5 Air", max_tokens: 131072, supports_vision: false, supports_tools: true },
];
