...
pub const ICON_URL: &str = "/public/providers/ocf.webp";
...
pub const MODELS: &[ModelDef] = &[
    ...
    ModelDef { id: "hy3-free", name: "Tencent Hy3 Free", max_tokens: 128000, supports_vision: false, supports_tools: true },
];
