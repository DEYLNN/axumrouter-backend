...
pub const ICON_NAME: &str = "ocg.webp";
pub const DOCS_URL: &str = "https://opencode.ai/auth";
pub const API_KEY_URL: &str = "https://opencode.ai/auth";
pub const DEFAULT_TIMEOUT_SECS: u64 = 180;

pub const MODELS: &[ModelDef] = &[
    ModelDef { id: "qwen3.7-max", name: "Qwen 3.7 Max", max_tokens: 1000000, supports_vision: false, supports_tools: true },
    ModelDef { id: "qwen3.7-plus", name: "Qwen 3.7 Plus", max_tokens: 1000000, supports_vision: false, supports_tools: true },
    ModelDef { id: "qwen3.6-plus", name: "Qwen 3.6 Plus", max_tokens: 1000000, supports_vision: false, supports_tools: true },
    ModelDef { id: "glm-5.2", name: "GLM 5.2", max_tokens: 1000000, supports_vision: false, supports_tools: true },
    ModelDef { id: "minimax-m3", name: "MiniMax M3", max_tokens: 524288, supports_vision: false, supports_tools: true },
    ModelDef { id: "kimi-k2.7-code", name: "Kimi K2.7 Code", max_tokens: 262144, supports_vision: false, supports_tools: true },
    ...
    ModelDef { id: "mimo-v2.5", name: "Mimo V2.5", max_tokens: 1000000, supports_vision: false, supports_tools: true },
    ModelDef { id: "mimo-v2.5-pro", name: "Mimo V2.5 Pro", max_tokens: 1000000, supports_vision: false, supports_tools: true },
];
