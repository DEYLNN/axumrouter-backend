...
use super::auth::KioCredential;
use super::client::KioClient;
use super::constants;
...
impl Provider for KioProvider {
    ...
    async fn chat_completion(
        ...
        for _ in 0..total {
            ...
            let cred = match KioCredential::parse(&key.key_value) {
                Ok(c) => c,
                Err(e) => {
        ...
        Err(GatewayError::NoAvailableKeys(
            "No KiosAPI keys configured".into(),
        ))
    }
