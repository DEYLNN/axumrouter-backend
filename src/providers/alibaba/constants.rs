...
pub const PROVIDER_ID: &str = "al";
pub const PROVIDER_NAME: &str = "Alibaba";
pub const MODEL_PREFIX: &str = "al";
pub const BASE_URL: &str = "https://coding.dashscope.aliyuncs.com";
pub const VALIDATE_URL: &str = "https://coding.dashscope.aliyuncs.com/v1/models";
pub const CATEGORY: &str = "apikey";
pub const COLOR: &str = "#FF6A00";
pub const ICON_NAME: &str = "alibaba.png";
...
pub const MODELS: &[ModelDef] = &[
    ...
    ModelDef { id: "qwen3-max", name: "Qwen 3 Max", max_tokens: 1000000, supports_vision: false, supports_tools: true },
